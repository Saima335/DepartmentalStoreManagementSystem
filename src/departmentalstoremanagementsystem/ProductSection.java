 ...
 * @author me
 */
public class ProductSection extends JFrame {
	...
	ImageIcon ic=new ImageIcon(ClassLoader.getSystemResource("images/ProductSection.png"));
	...
	l1.setLayout(null);
        ...
        b1=new JButton("Product Details");
        b1.setBounds(500,300,300,30);
	b1.setForeground(Color.ORANGE);
	b1.setBackground(Color.BLACK);
	b1.setFont(new Font("serif",Font.ITALIC,20));
                
        b2=new JButton("Requirement of the Products");
    ...
    public class MyActionListener implements ActionListener{
        public void actionPerformed(ActionEvent e){
            ...
            if (e.getActionCommand()=="Product Details"){
                dispose();
                ProductDetails details=new ProductDetails();
            }
            if(e.getActionCommand()=="Requirement of the Products"){
                dispose();
