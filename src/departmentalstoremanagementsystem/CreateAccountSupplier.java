 ...
 * @author me
 */
public class CreateAccountSupplier extends JFrame{
    JButton b1;
    JLabel l1,l2,l3;
    JTextField t1,t2,t3;
    CreateAccountSupplier(String msg){
        super("Customer Account Supplier");
        ...
        public void actionPerformed(ActionEvent e){	
            if(e.getSource()==b1) {
                try{
                    ...
                    String m="Insert into LoginHasSupplier(username,password,SupplierID) values('"+a+"','"+b+"',"+c+")";
