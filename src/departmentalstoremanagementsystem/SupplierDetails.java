...
public class SupplierDetails extends JFrame{
    ...
    SupplierDetails(){
        ...
        l3=new JLabel("Supplier City: ");
        l4=new JLabel("Supplier State: ");
        l5=new JLabel("Supplier Pin Code: ");
        l6=new JLabel("Supplier Contact No in the format xxxxxxxxxxx: ");
        l7=new JLabel("Gate Entry No: ");
        ...
        try{
            ...
            ResultSet rs=c.s.executeQuery("select GateEntryNo from gateentry");
	    while(rs.next()){
                c1.add(Integer.toString(rs.getInt("GateEntryNo")));
	    }
        }catch(Exception ee) { }
    ...
    public class MyActionListener implements ActionListener{
        public void actionPerformed(ActionEvent e){
            ...
            if(e.getSource()==b1) {
                if(t1.getText().equals("")||t2.getText().equals("")||t5.getText().equals("")||t6.getText().equals("") || c1.getSelectedIndex()==-1){
                    ...
                    try {
                        if (checkAllDigits(t1.getText())){
                            if (checkPhoneNo(t6.getText())){
                                ...
                                String f=t6.getText();
                                int g=Integer.parseInt(c1.getSelectedItem());
                                Connector con=new Connector();
                                String m="Insert into supplierdetails(SupplierID,SupplierName,SupplierCity,SupplierState,SupplierPinCode,SupplierContactNo,GateEntryNo) values("+a+",'"+b+"','"+c+"','"+d+"','"+ee+"','"+f+"',"+g+")";
                                con.s.executeUpdate(m);
                                JOptionPane.showMessageDialog(null, "Supplier Details Added Successfully");
                                String msg=t1.getText();
                                dispose();
                                CreateAccountSupplier account=new CreateAccountSupplier(msg);
                            }
                            else{
                            ...
                            JOptionPane.showMessageDialog(null, "Enter only digits as supplier id");
                        }
                    }
                    catch(Exception ex) {
